...
public:
  ...
  int     GetHeight()
    { return m_pImage == nullptr ? (m_pBitmap->GetHeight() / m_iNumFrames) : (m_pImage->GetHeight() / m_iNumFrames); };
};
